...
if (Compiler.isJava){
    ...
    private macro void _set_macro(mcposition position, mcobject block){
        /setblock $(position) $(block)
    }
    private macro void _fill_macro(mcposition start, mcposition end, mcobject block){
        /fill $(start) $(end) $(block)
    }
    private macro void _replace_macro(mcposition start, mcposition end, mcobject block, mcobject fro){
        /fill $(start) $(end) $(block) replace $(fro)
    }
    private macro void _fill_macro(mcposition start, mcposition end, mcobject block, string mod){
        /fill $(start) $(end) $(block) $(mod)
    }
    private macro void _clone_macro(mcposition start, mcposition end, mcposition target, string mod1, string mod2){
        /clone $(start) $(end) $(target) $(mod1) $(mod2)
    }
}
