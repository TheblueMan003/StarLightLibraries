...
if (Compiler.isJava){
    def private macro setSlot(string slot, mcobject item, int count = 1){
...
predicate isHoldingItemHead(mcobject item, int count, json data){
    "condition": "minecraft:entity_properties",
    "entity": "this",
    "predicate": {
        "equipment": {
...
predicate isHoldingItemChest(mcobject item, int count, json data){
    "condition": "minecraft:entity_properties",
    "entity": "this",
    "predicate": {
        "equipment": {
...
predicate isHoldingItemLegs(mcobject item, int count, json data){
    "condition": "minecraft:entity_properties",
    "entity": "this",
    "predicate": {
        "equipment": {
...
predicate isHoldingItemFeet(mcobject item, int count, json data){
    "condition": "minecraft:entity_properties",
    "entity": "this",
    "predicate": {
        "equipment": {
...
predicate isHoldingItemOffhand(mcobject item, int count, json data){
    "condition": "minecraft:entity_properties",
    "entity": "this",
    "predicate": {
        "equipment": {
